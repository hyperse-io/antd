...
Hi! Thank you for taking the time to contribute to jsonbricks!

In order to make the best use of both your time and that of the jsonbricks maintainers, please follow the guidelines in this document.
...
After cloning the artmit repo, please follow the [Development guide](https://github.com/jsonbricks/jsonbricks/blob/master/README.md#development) in the README for instructions on how to get up and running locally.
